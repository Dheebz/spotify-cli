...
use crate::cli::commands::{self, ArtistQuery, ArtistView, SearchFilters, SearchOptions};
        ...
        match request.method.as_str() {
            ...
            "pin.add" => {
                ...
                let alias = params
                    ...
                    .and_then(|v| v.as_str())
                    .unwrap_or("");
                let tags = params.and_then(|p| p.get("tags")).and_then(|v| v.as_str());
            ...
            "pin.list" => {
                let resource_type = params.and_then(|p| p.get("type")).and_then(|v| v.as_str());
