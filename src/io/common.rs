...
mod tests {
    ...
    fn format_duration_as_short() {
        ...
        assert_eq!(
            format_duration_as(3661000, DurationFormat::Short),
            "1:01:01"
        );
    }
    ...
    fn format_duration_as_long_with_seconds() {
        assert_eq!(
            format_duration_as(30000, DurationFormat::LongWithSeconds),
            "30s"
        );
        assert_eq!(
            format_duration_as(90000, DurationFormat::LongWithSeconds),
            "1m 30s"
        );
        assert_eq!(
            format_duration_as(3661000, DurationFormat::LongWithSeconds),
            "1h 1m"
        );
    }
