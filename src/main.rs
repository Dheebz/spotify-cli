...
use spotify_cli::cli::{
    ...
    DaemonCommand, DevicesCommand, EpisodeCommand, FollowCommand, InfoCommand, LibraryCommand,
    PinCommand, PlayerCommand, PlaylistCommand, QueueCommand, ShowCommand, UserCommand,
    print_completions,
};
