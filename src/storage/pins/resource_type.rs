...
mod tests {
    ...
    fn from_str_valid() {
        assert_eq!(
            ResourceType::from_str("playlist").unwrap(),
            ResourceType::Playlist
        );
        assert_eq!(
            ResourceType::from_str("track").unwrap(),
            ResourceType::Track
        );
        assert_eq!(
            ResourceType::from_str("album").unwrap(),
            ResourceType::Album
        );
        assert_eq!(
            ResourceType::from_str("artist").unwrap(),
            ResourceType::Artist
        );
        assert_eq!(ResourceType::from_str("show").unwrap(), ResourceType::Show);
        assert_eq!(
            ResourceType::from_str("episode").unwrap(),
            ResourceType::Episode
        );
        assert_eq!(
            ResourceType::from_str("audiobook").unwrap(),
